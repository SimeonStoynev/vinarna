...
@Table(name = "bottle_storage")
@Entity
public class BottleStorage {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BottleStorage)) return false;
        BottleStorage that = (BottleStorage) o;
        return id == that.id && quantity_old == that.quantity_old && quantity == that.quantity && difference == that.difference && bottle_type_id.equals(that.bottle_type_id) && created_at.equals(that.created_at) && updated_at.equals(that.updated_at);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, bottle_type_id, quantity_old, quantity, difference, created_at, updated_at);
    }
